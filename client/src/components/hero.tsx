      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl items-end px-4 pb-40 sm:px-6 lg:px-8">
        <div ref={ref} className="reveal text-white max-w-4xl">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-6">
            <a
              href="#wines"
              className="group inline-flex items-center justify-center rounded-3xl bg-honey-500/90 backdrop-blur-sm border border-honey-400/60 px-6 sm:px-10 py-5 text-base font-medium text-white hover:bg-honey-600/90 hover:border-honey-300/80 transition-all duration-500 luxury-shadow"
            >
            ...
            <a
              href="#story"
              className="group inline-flex items-center justify-center rounded-3xl border-2 border-white/40 backdrop-blur-sm px-6 sm:px-10 py-5 text-base font-medium text-white hover:bg-white/15 transition-all duration-500"
            >
